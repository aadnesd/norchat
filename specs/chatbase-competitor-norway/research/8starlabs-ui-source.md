...
- Docs: https://ui.8starlabs.com
 - README confirms Next.js + shadcn/ui integration focus and CLI install pattern.
...
- Configurable as a third-party registry via shadcn/ui `components.json`.
 - Component catalog: https://ui.8starlabs.com/docs/components
